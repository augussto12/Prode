...
export default function TournamentBracket({ fixtures }) {
  ...
  return (
    ...
    >
      ...
      <div className="text-xs text-white/60 mb-2 flex items-center justify-end sm:hidden px-2 gap-1 animate-pulse">
        ...
        <div className="px-3 py-1.5 bg-white/[0.01] border-t border-white/5 flex gap-2 justify-center">
          {legs.map((leg, li) => (
            <button
              ...
              className="text-[10px] text-white/50 hover:text-indigo-300 transition-colors cursor-pointer bg-transparent border-none"
            >
