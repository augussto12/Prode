...
import { Save, Search, UserPlus, Trash2, Calendar, X, ArrowLeft, Loader2, Pencil, Check, Crown, ChevronLeft, ChevronRight } from 'lucide-react';
                       ...
                       <div className="flex items-center gap-1.5">
                          {draftPicks.length === 11 && activeGw?.status !== 'IN_PROGRESS' && (
                            <button 
                              ...
                              className={`px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg sm:rounded-xl text-[11px] sm:text-sm font-bold flex items-center gap-1.5 transition border-none cursor-pointer ${
                                selectingCaptain 
