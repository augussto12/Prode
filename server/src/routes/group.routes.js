...
import { groupCreateSchema, groupInviteSchema, groupThemeSchema, joinGroupSchema } from '../validators/schemas.js';
...
router.get('/:id/activity', authenticate, requireGroupMember, ctrl.getActivity);
...
// Admin del grupo
router.get('/:id/invites', authenticate, requireGroupAdmin, ctrl.getInvites);
router.post('/:id/invites', authenticate, requireGroupAdmin, validate(groupInviteSchema), ctrl.addInvite);
router.delete('/:id/invites/:inviteId', authenticate, requireGroupAdmin, ctrl.revokeInvite);
